defmodule OQueMudou.Search.Index do
  @moduledoc """
  ...
  write (`OQueMudou.Summarizer.embed_summary/1`). No pgvector — brute-force
  ...
  *caller's* process (no GenServer round-trip), so tests can call it directly
  ...
  effective `OQueMudou.Summarizer.Embeddings` config (`OQueMudou.Admin.embeddings_config/0`).
  """
