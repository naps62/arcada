defmodule ArcadaWeb.UserRegistrationGatingTest do
  ...
  describe "daily signup cap" do
    setup do
      original = Application.get_env(:arcada, :daily_signup_cap)
      Application.put_env(:arcada, :daily_signup_cap, 0)
      on_exit(fn -> Application.put_env(:arcada, :daily_signup_cap, original) end)
    end
  ...
  describe "timing gate" do
    setup do
      original = Application.get_env(:arcada, :signup_min_fill_ms)
      Application.put_env(:arcada, :signup_min_fill_ms, 60_000)
      on_exit(fn -> Application.put_env(:arcada, :signup_min_fill_ms, original) end)
    end
