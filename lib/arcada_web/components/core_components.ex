defmodule ArcadaWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ArcadaWeb.Gettext
  ...
  use Phoenix.VerifiedRoutes,
    ...
    statics: ArcadaWeb.static_paths()
  ...
  def act_entry(assigns) do
    ...
    <article class="py-5">
      ...
      <p class="mt-2.5 max-w-reading text-pretty font-serif text-[1.0625rem] leading-relaxed text-ink">
        {Arcada.Register.Summary.strip_terms(@summary.plain_text)}
      </p>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ArcadaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ArcadaWeb.Gettext, "errors", msg, opts)
    end
  end
