defmodule ArcadaWeb.Plugs.RequireAdminHostTest do
  ...
  setup do
    prev = Application.get_env(:arcada, :admin, [])
    on_exit(fn -> Application.put_env(:arcada, :admin, prev) end)
    :ok
  end

  defp put_admin(opts), do: Application.put_env(:arcada, :admin, opts)
