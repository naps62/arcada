defmodule OQueMudouWeb.UserSettingsLive do
    ...
    <div class="space-y-12 divide-y">
      <div>
        ...
        >
          ...
          />
          <:actions>
            <.button phx-disable-with="A alterar...">Alterar email</.button>
          </:actions>
        </.simple_form>
      </div>
      <div>
        ...
        >
          ...
          />
          <:actions>
            <.button phx-disable-with="A guardar...">Guardar nome de utilizador</.button>
          </:actions>
        </.simple_form>
      </div>
      <div>
        ...
        >
          ...
          />
          <:actions>
            <.button phx-disable-with="A alterar...">Alterar palavra-passe</.button>
          </:actions>
        </.simple_form>
      </div>
    </div>
  ...
  def mount(%{"token" => token}, _session, socket) do
    socket =
      case Accounts.update_user_email(socket.assigns.current_user, token) do
        ...
        :error ->
          put_flash(socket, :error, "O endereço de alteração de email é inválido ou expirou.")
      end
  ...
  def handle_event("update_email", params, socket) do
    ...
    case Accounts.apply_user_email(user, password, user_params) do
      {:ok, applied_user} ->
        ...
        info = "Enviámos um endereço para confirmar a alteração para o novo email."
    ...
    case Accounts.update_user_username(socket.assigns.current_user, user_params) do
      {:ok, user} ->
        {:noreply,
         ...
         |> put_flash(:info, "Nome de utilizador guardado.")}
