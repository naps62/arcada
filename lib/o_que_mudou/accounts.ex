defmodule OQueMudou.Accounts do
  @moduledoc """
  ...
  alias OQueMudou.Accounts.{User, UserToken, UserNotifier}
  ...
  @doc """
  Returns an `%Ecto.Changeset{}` for changing the user's public username.
  """
  ...
  @doc """
  Updates the user's public username (optional display handle).

  ## Examples

      iex> update_user_username(user, %{username: "ana"})
      {:ok, %User{}}

      iex> update_user_username(user, %{username: "taken"})
      {:error, %Ecto.Changeset{}}
