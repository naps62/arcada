defmodule OQueMudou.Scraper.IngestWorker do
  @moduledoc """
  ...
  after publication) and is also the unit `OQueMudou.Scraper.backfill/1` enqueues
  per date.
  ...
  alias OQueMudou.{Register, Scraper, Summarizer}
  ...
  defp ingest_opts do
    case Application.get_env(:o_que_mudou, :ingest_client) do
      nil -> []
