defmodule ArcadaWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: ArcadaWeb.Layouts]
  ...
  def live_view_admin do
    quote do
      use Phoenix.LiveView,
        layout: {ArcadaWeb.Layouts, :admin}

      on_mount ArcadaWeb.AdminNav
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import ArcadaWeb.CoreComponents
