defmodule Arcada.ScraperTest do
  use Arcada.DataCase, async: true

  alias Arcada.Repo
  alias Arcada.Scraper
  alias Arcada.Scraper.Client
  alias Arcada.Register.{Edition, Act}
  ...
  defp stub_client(opts \\ []) do
    ...
    Req.Test.stub(Arcada.DREStub, fn conn ->
    ...
    %{
      Client.new(req_options: [plug: {Req.Test, Arcada.DREStub}])
